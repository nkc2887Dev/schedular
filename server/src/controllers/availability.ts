...
import { validateTimeRange, validateDate } from '../utils/validation';
...
export const getUserAvailabilitySlot = async (
  req: Request | any,
  res: Response
) => {
  try {
...
export const updateUserAvailabilitySlot = async (
  req: Request | any,
  res: Response
) => {
  try {
...
export const deleteUserAvailabilitySlot = async (
  req: Request | any,
  res: Response
) => {
  try {
